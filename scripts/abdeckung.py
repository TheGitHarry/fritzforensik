...
def erzeuge(befunde: list[dict]) -> str:
    ...
    a("  das Bündel auf der Platte — dass es **kein netzfähiges Modul** verwendet,")
    a("  auch keines aus der Standardbibliothek, ist durch einen Test festgehalten")
    a("  (`tests/format/test_stdlib_only.py`). Wer die Werkzeuge herunterlädt und auf")
    a("  eigenen Geräten einsetzt, gibt keine Daten heraus.")
